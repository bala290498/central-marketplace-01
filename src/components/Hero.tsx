    ...
    <section id="home" className="relative bg-slate-50 overflow-hidden pt-0 pb-12 sm:pb-16 lg:pb-20">
      ...
      */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start pt-2 sm:pt-12">
          ...
          <div className="lg:col-span-8 space-y-1 sm:space-y-6">
            ...
            {/* Main Headline */}
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black text-slate-900 tracking-tight leading-tight -mt-0.5 sm:mt-0">
              Find Locally! <br />
